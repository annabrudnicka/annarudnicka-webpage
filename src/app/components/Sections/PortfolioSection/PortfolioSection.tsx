        ...
        <div className="flex flex-col sm:flex-row">
          <div className="sm:w-1/2">
            <div className="scale-in-element">
              <h3 className="font-playfair mb-6 sm:mb-3 text-3xl text-center">
                Food Planner
              </h3>
          ...
          <div className="sm:w-1/2">
            <div className="scale-in-element flex flex-col justify-between">
              <div>
                <h3 className="font-playfair sm:mb-3 text-3xl text-center sm:my-0">
                  Eisenhower Matrix
                </h3>
                <p className="text-md text-gray-600 mb-3">
            ...
            <div className="scale-in-element">
              <article className=" rounded-2xl shadow-xl border border-gray-300 sm:w-96 mx-auto">
