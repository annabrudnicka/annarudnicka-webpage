...
export const experiences = [
  {
    ...
    period: "01.2024 - currently",
    projects: [
      {
        title: "Independent Application Development",
  ...
  },
  {
    ...
    projects: [
      {
        title: "Technical Design and Invoicing",
  ...
  },
  {
    ...
    projects: [
      {
        title: "Project: Lemon / Zurich Insurers (Scrum) - Insurance",
        methodology: "Scrum",
        industry: "Insurance",
        tasks: [
          {
      ...
      {
        title: "Project: Salog / Kuehne Nagel (Kanban) - Logistics",
        methodology: "Kanban",
        industry: "Logistics",
        tasks: [
          {
      ...
      {
        title: "Paid Internship: Java Starter Kit",
        methodology: "N/A",
        industry: "N/A",
        tasks: [
  ...
  },
  {
    ...
    projects: [
      {
        title: "Prefabricated Concrete Drainage Design",
        methodology: "Traditional",
        industry: "Construction",
        tasks: [
          {
